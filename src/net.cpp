...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Recyclecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"recyclecointools.com", "dnsseed.recyclecointools.com"},
    {"recyclecoinpool.org", "dnsseed.recyclecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"recyclecointools.com", "testnet-seed.recyclecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Recyclecoin is probably already running."), addrBind.ToString().c_str());
        else
